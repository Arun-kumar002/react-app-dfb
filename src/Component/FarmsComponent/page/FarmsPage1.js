...
import {useNavigate} from 'react-router-dom';
 ...
 const images =[
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-725618445959793719/original/5d874a75-9faa-4ef2-8ca6-2437754fabce.jpeg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-725618445959793719/original/1d4a9faf-eaf0-4c86-a61c-20dac7ce6567.jpeg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-725618445959793719/original/360ff283-f749-47d5-8a33-ddbb782a8273.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-725618445959793719/original/2d6c84f8-6e1e-487f-a2e4-0d4203562848.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-725618445959793719/original/7c44f901-c80c-4f08-8964-4b7e00141e0e.jpeg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-725618445959793719/original/ff7e8e6e-f8e5-417e-821b-e2262029a6c0.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-725618445959793719/original/8af84050-e440-4d14-855f-638f778af0e9.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-725618445959793719/original/54f83b08-3e3b-4999-9d6c-d12dd3a21c09.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-725618445959793719/original/86c65277-5d93-4391-b843-c683844132ef.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-725618445959793719/original/59d82ef4-ebb6-4199-8e4b-7da5c6877dbb.jpeg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-725618445959793719/original/cdafd28a-0b05-4836-8c91-33e9a21aefb6.jpeg?im_w=1200" }
 ]
...
<>
    ...
    <h3 style={{ margin:"40px 0px 10px 100px"}}>Fun and quiet condo with climbing wall</h3>
   ...
   <p>
    ...
    <div class="row">
      <div style={{display: "flex", flexDirection: "column"}} class="col">
         <h6>₹3,036 x 5 nights</h6></div>
      <div style={{display: "flex"}} class="col" >
            <p >₹17,650</p></div>     
    </div> 
    <div class="row">
      <div style={{display: "flex", flexDirection: "column"}} class="col">
         <h6>Long stay discount</h6></div>
      <div style={{display: "flex"}} class="col" >
            <p >-₹2,471</p></div>    
    </div> 
    <div class="row">
    ...
    <div class="row">
      ...
      <div style={{display: "flex"}} class="col" >
        ...
        <h4 style={{ margin:"40px 0px 15px 100px"}}>Entire apartment hosted by Tomaž</h4>
