...
import {useNavigate} from 'react-router-dom';
 ...
 function FarmsPage5() {const navigate = useNavigate();
 const [date, setDate] = useState(new Date());
 const images =[
   { "url": "https://a0.muscache.com/im/pictures/73640504/9fefd9b9_original.jpg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/73640550/bf22eada_original.jpg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/73640725/1d74464f_original.jpg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/73641036/0bc7149c_original.jpg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/73642379/c9a8b945_original.jpg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/73642701/1bbf818e_original.jpg?im_w=720"},
   { "url": "https://a0.muscache.com/im/pictures/73642843/3030388a_original.jpg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/73643088/a9df13ab_original.jpg?im_w=1200"}
]
...
<>
    ...
    <h3 style={{ margin:"40px 0px 10px 100px"}}>The Lanes at Meemo's Farm</h3>
   ...
   <p>
    ...
    <div class="row">
      ...
      <div style={{display: "flex"}} class="col" >
        ...
        <h4 style={{ margin:"40px 0px 15px 100px"}}>Entire home hosted by Meemo'S</h4>
    ...
    <div class="row">
       ...
       <div class="col-6">
        <p><b>Meemo'S is a Superhost</b></p>
