...
import {useNavigate} from 'react-router-dom';
 ...
 function LakefrontPage5() {const navigate = useNavigate();
 const [date, setDate] = useState(new Date());
 const images =[
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-671102227653833112/original/81f37691-b94d-4a32-a759-d45d30608ec0.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-671102227653833112/original/9f75d862-cb2e-424c-ba30-2d7c61791a1f.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-671102227653833112/original/a59e0bca-6951-4e2d-b11d-bf231ed6014b.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-671102227653833112/original/43222aa3-c183-4da0-bbf5-e4bd609b0add.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-671102227653833112/original/a55f220f-6300-422f-8943-8700476aea1d.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/1352c9e0-2ea7-4f0d-b0d6-8f75138d4e38.jpg?im_w=720"},
   { "url": "https://a0.muscache.com/im/pictures/21618413-795c-4244-9840-febb1418bb47.jpg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/4cc3e8b4-eb03-4839-825a-445151236b2f.jpg?im_w=720"},
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-671102227653833112/original/a7aaa5c6-b880-4284-b572-f6fef1435a20.jpeg?im_w=720"}
]
...
<>
    ...
    <h3 style={{ margin:"40px 0px 10px 100px"}}>(#7) * ALL-NEW* Tiny Meets Luxury-ADA Tiny Home</h3>
   ...
   <p>
    ...
    <button style={{width:"355px", margin:"15px 3px"}} type="button" class="btn btn-danger" onClick={()=>navigate("/payment5")}>Reserve</button>
    <div class="row">
      <div style={{display: "flex", flexDirection: "column"}} class="col">
         <h6>₹9,721 x 5 nights</h6></div>
      <div style={{display: "flex"}} class="col" >
            <p >₹48,607</p></div>     
    </div> 
    <div class="row">
    ...
    <div class="row">
      ...
      <div style={{display: "flex"}} class="col" >
        ...
        <h4 style={{ margin:"40px 0px 15px 100px"}}>Tiny home hosted by Tim & Lynn</h4>
    ...
    <div class="row">
       ...
       <div class="col-6">
        <p><b>Tim & Lynn is a Superhost</b></p>
