...
import {useNavigate} from 'react-router-dom';
 ...
 function LakefrontPage3() {const navigate = useNavigate();
 const [date, setDate] = useState(new Date());
 const images =[
   { "url": "https://a0.muscache.com/im/pictures/monet/Luxury-592658939466266806/original/7833ed5a-30d0-4492-82d6-e66a8550220a?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/monet/Luxury-592658939466266806/original/030bb94e-978e-420c-9290-383578d21b06?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/monet/Luxury-592658939466266806/original/e96ea2de-bc43-4b6e-b865-e0e5be3a0a4b?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/monet/Luxury-592658939466266806/original/8ba68162-98d4-4c62-be89-1455b56396b9?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/monet/Luxury-592658939466266806/original/3f182fc6-bfab-40bc-9ad1-9ebe030661e4?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/monet/Luxury-592658939466266806/original/ca99de6b-406b-4fee-9971-11779ff1ec72?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/monet/Luxury-592658939466266806/original/c3e026fd-bb51-4ab8-be24-34116ae5fb1f?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/monet/Luxury-592658939466266806/original/6a1104c3-dea1-4178-ba05-302afb3af07d?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/monet/Luxury-592658939466266806/original/e4029c02-cb15-4614-a7c9-3224bb701ca4?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/monet/Luxury-592658939466266806/original/072bd9cb-28f7-4a2c-aace-6a978b1806a0?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/monet/Luxury-592658939466266806/original/d70f58d2-2697-4c11-b225-50be717c3227?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/monet/Luxury-592658939466266806/original/60054224-43f1-4141-b1a8-1b424907bcff?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/monet/Luxury-592658939466266806/original/db98dd3b-d6df-445f-93df-c18623d74e7a?im_w=1200" }
 ]
...
<>
    ...
    <h3 style={{ margin:"40px 0px 10px 100px"}}>Kadenwood Winterfell</h3>
   ...
   <p>
    ...
    <button style={{width:"355px", margin:"15px 3px"}} type="button" class="btn btn-danger" onClick={()=>navigate("/payment3")}>Reserve</button>
    <div class="row">
      <div style={{display: "flex", flexDirection: "column"}} class="col">
         <h6>₹6,61,921  x 5 nights</h6></div>
      <div style={{display: "flex"}} class="col" >
            <p >₹33,09,607</p></div>     
    </div> 
    <div class="row">
      <div style={{display: "flex", flexDirection: "column"}} class="col">
         <h6>Hospitality fees</h6></div>
      <div style={{display: "flex"}} class="col" >
            <p >₹2,09,913</p></div>    
    </div> 
    <div class="row">
    ...
    <div class="row">
      ...
      <div style={{display: "flex"}} class="col" >
        ...
        <h4 style={{ margin:"40px 0px 15px 100px"}}>Luxury stay in Whistler, British Columbia, Canada</h4>
