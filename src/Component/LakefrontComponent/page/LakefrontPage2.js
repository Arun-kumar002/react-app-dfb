...
import {useNavigate} from 'react-router-dom';
 ...
 function LakefrontPage2() {const navigate = useNavigate();
 const [date, setDate] = useState(new Date());
 const images =[
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-694991113796634774/original/3f2a00d9-2774-4d9e-8d63-38c0a105f435.jpeg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-694991113796634774/original/d266b515-4844-4a97-8029-3cf3627ec071.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-694991113796634774/original/e47c2813-bc34-43d2-be98-c0890f8c3ab6.jpeg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-694991113796634774/original/9d67a3f4-51b3-457e-9cac-373059134d8c.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-694991113796634774/original/5c8f9eb7-3064-472f-8a40-daca78a578c4.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-694991113796634774/original/2b07d82c-5fe3-4fdb-996e-30df4146e811.jpeg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-694991113796634774/original/7815e12e-915b-4f5b-91d6-209f1bc25ea3.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-694991113796634774/original/7cc6983e-e5f5-4487-a466-b34df37a6e8a.jpeg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-694991113796634774/original/2f243f4f-de16-4b62-8c36-14f6e5ea7a1d.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-694991113796634774/original/abfee4fd-98e3-405f-bb95-b5db57d52fbf.jpeg?im_w=1200" }
]
...
<>
    ...
    <h3 style={{ margin:"40px 0px 10px 100px"}}>Luxe Dome + Hot Tub + View + Wheelchair Accessible</h3>
   ...
   <p>
    ...
    <button style={{width:"355px", margin:"15px 3px"}} type="button" class="btn btn-danger" onClick={()=>navigate("/payment2")}>Reserve</button>
    <div class="row">
      <div style={{display: "flex", flexDirection: "column"}} class="col">
         <h6>₹26,550 x 5 nights</h6></div>
      <div style={{display: "flex"}} class="col" >
            <p >₹1,32,750</p></div>     
    </div> 
    <div class="row">
    ...
    <div class="row">
      ...
      <div style={{display: "flex"}} class="col" >
        ...
        <h4 style={{ margin:"40px 0px 15px 100px"}}>Dome hosted by Matt</h4>
