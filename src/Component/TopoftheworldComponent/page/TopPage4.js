...
import {useNavigate} from 'react-router-dom';
 ...
 function TopPage4() {const navigate = useNavigate();
 const [date, setDate] = useState(new Date());
 const images =[
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-51935866/original/1afb744f-3c3c-40f3-a0b1-934a8e344e5c.jpeg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-51935866/original/67545752-257c-4995-805d-c11b1f5308d4.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-51935866/original/5342b262-059c-450a-85b8-5987cc7c228e.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-51935866/original/b61d738b-681c-4934-ae85-404127374508.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-51935866/original/540e6092-3a9b-4dff-ab8d-e2d09117d284.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-51935866/original/0b827c30-891d-4af6-8619-ac4ebfc65a32.jpeg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-51935866/original/d3141049-f2b6-4e6f-9adb-cc62833e2929.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-51935866/original/4d9a38a2-c90a-4830-9310-4f1104d0bd2f.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-51935866/original/787493b5-80ae-4f69-a592-3e95eea94fd5.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-51935866/original/fe00b9e4-beb6-4016-97b4-f427207d8f3f.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-51935866/original/0ec8abd6-3f2d-4e14-8424-d34c61c0bd08.jpeg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-51935866/original/9833b297-a8e7-4440-ab92-2c132f46917a.jpeg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-51935866/original/1b0f09ee-7c99-4a51-a8aa-edc019ff91cd.jpeg?im_w=1200" }
]
...
<>
    ...
    <h3 style={{ margin:"40px 0px 10px 100px"}}>A Private room in an Earth House</h3>
   ...
   <p>
    ...
    <button style={{width:"355px", margin:"15px 3px"}} type="button" class="btn btn-danger" onClick={()=>navigate("/payment4")}>Reserve</button>
    <div class="row">
      <div style={{display: "flex", flexDirection: "column"}} class="col">
         <h6>₹1,066 x 6 nights</h6></div>
      <div style={{display: "flex"}} class="col" >
            <p >₹6,396</p></div>     
    </div> 
    <div class="row">
    ...
    <div class="row">
      ...
      <div style={{display: "flex"}} class="col" >
        ...
        <h4 style={{ margin:"40px 0px 15px 100px"}}>Private room in earthen home hosted by Ishan</h4>
