...
import {useNavigate} from 'react-router-dom';
 ...
 function TopPage6() {const navigate = useNavigate();
 const [date, setDate] = useState(new Date());
 const images =[
   { "url": "https://a0.muscache.com/im/pictures/4ac06cba-7b1d-4d8c-b124-1d956726c797.jpg?im_w=1200" },
   { "url": "https://a0.muscache.com/im/pictures/0dead576-d896-4d74-96ee-05d430de2019.jpg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/3a0f4c11-b2ed-473e-92f0-2488f5aac973.jpg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/049c6e0d-77e7-4356-9749-3199288c958d.jpg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/0f03bdea-f3fd-4b8b-accc-b7d470486f22.jpg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/b48ed278-9004-4f20-962e-7880ffbe7aa8.jpg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/d85e5510-2aff-4883-801a-c17f01f1ff5a.jpg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/fbe26d5d-9d23-477f-ad22-2bc5c63982b4.jpg?im_w=720" },
   { "url": "https://a0.muscache.com/im/pictures/6dc2bf5c-c2ef-4b98-8751-74f05925cb1c.jpg?im_w=1200" }
]
...
<>
    ...
    <h3 style={{ margin:"40px 0px 10px 100px"}}>Domos Blue, Maxi blue</h3>
   ...
   <p>
    ...
    <div class="row">
      ...
      <div style={{display: "flex"}} class="col" >
        ...
        <h4 style={{ margin:"40px 0px 15px 100px"}}>Private room in dome hosted by Tatiana</h4>
    ...
    <div class="row">
       ...
       <div class="col-6">
        <p><b>Tatiana is a Superhost</b></p>
