...
import {useNavigate} from 'react-router-dom';
 ...
 const images =[
        ...
        { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-717134404264905813/original/dd8cce90-5993-463e-bed8-5da785016db2.jpeg?im_w=1200" },
        { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-717134404264905813/original/253aa05d-b3b5-4f77-b71b-cbd3e90464aa.jpeg?im_w=1200" },
        { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-717134404264905813/original/8be8a54e-3b8b-4612-9605-dc3fbf77834e.jpeg?im_w=1200" },
        { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-717134404264905813/original/ba3050ec-61fc-408c-920c-5a89e339e4e1.jpeg?im_w=1200" },
        { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-717134404264905813/original/dd8cce90-5993-463e-bed8-5da785016db2.jpeg?im_w=1200" },
        { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-717134404264905813/original/8ac91219-6874-4ca6-915f-bcaf04a04c41.jpeg?im_w=1200" },
        { "url": "https://a0.muscache.com/im/pictures/miso/Hosting-717134404264905813/original/5f881acb-a3c4-46ae-8a3e-9f580bb5e788.jpeg?im_w=1200" }
     ]     
...
<>
    ...
    <h3 style={{ margin:"40px 0px 10px 100px"}}>Hidden Haven - 5 Bed Villa with pool & Sea Views</h3>
   ...
   <p>
     ...
     <span><b>CHECK-OUT:</b></span> {date[1].toDateString()}
        ...
        <p>
        <span><b>CHECK-IN:</b></span>{' '} {date.toDateString()}
    ...
    <div class="row">
      ...
      <div style={{display: "flex"}} class="col" >
        ...
        <h4 style={{ margin:"40px 0px 15px 100px"}}>Entire villa hosted by Jenny</h4>
